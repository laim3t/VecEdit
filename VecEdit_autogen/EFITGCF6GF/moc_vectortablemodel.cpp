...
QT_MOC_LITERAL(1, 17, 11), // "rowModified"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 3) // "row"

    },
    "VectorTableModel\0rowModified\0\0row"
};
...
void VectorTableModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->rowModified((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VectorTableModel::rowModified)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VectorTableModel::rowModified(int _t1)
{
