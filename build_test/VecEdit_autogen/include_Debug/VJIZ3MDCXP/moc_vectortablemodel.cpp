/****************************************************************************
** Meta object code from reading C++ file 'vectortablemodel.h'
**
...
#error "The header file 'vectortablemodel.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 17, 12), // "dataModified"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 3) // "row"

    },
    "VectorTableModel\0dataModified\0\0row"
};
...
void VectorTableModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<VectorTableModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataModified((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (VectorTableModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VectorTableModel::dataModified)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VectorTableModel::dataModified(int _t1)
{
